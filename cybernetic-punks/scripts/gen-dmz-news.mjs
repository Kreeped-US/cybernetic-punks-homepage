...
const SYSTEM_PROMPT = [
  ...
  '3. ATTRIBUTE EXPLICITLY. At least once in the body, name the source in plain',
  '   text -- "Call of Duty\'s official blog" or "the DMZ Deep Dive" -- so the reader',
  '   knows where these facts come from.',
  '4. NO FABRICATION. Use ONLY the facts in the SOURCE EXCERPT given in the user',
  ...
  '5. WRONG-GAME VOCABULARY IS BANNED. This is DMZ / Modern Warfare 4, a DIFFERENT',
  ...
  '   Hajin, and so on).',
  '6. READER ADDRESS. Address the audience as "you" or "players". Do NOT label the',
  ...
  '   characters) is fine.',
  '7. END WITH THE LAUNCH NOTE. Close with a brief, plain note that DMZ launches',
