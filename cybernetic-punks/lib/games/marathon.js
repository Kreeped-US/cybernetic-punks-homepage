...
export const marathon = {
  ...
  editorial: {
    ...
    generateNews: true,
    // SELF-SELECT capability (2026-09-18). MIRANDA may self-select a topic when NO queued candidate
    // passes the assignment gate. Marathon-ONLY today: her default (self-select) prompt is Marathon-
    // flavored (its OWN concepts -- correct for Marathon), and Marathon has rich data to self-select
    // from. Non-Marathon games OMIT this flag -> grounded-candidates-only: if no candidate passes,
    // MIRANDA SKIPS the cycle (produces nothing) rather than self-selecting an ungrounded/Marathon-
