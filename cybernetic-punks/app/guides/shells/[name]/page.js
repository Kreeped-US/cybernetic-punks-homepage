...
const SHELLS = {
  ...
  destroyer: {
    ...
    playstyle: 'Hold ground. Take cover, out-trade, advance. Destroyer isn\'t built for fancy plays — it\'s built to win contested zones through raw combat stats. Pair with heavy weapons and keep your crew close.',
  ...
  rook: {
    ...
    playstyle: 'Farm, do not fight. Run loot routes, take what the map gives you, and leave. You are carrying nothing of your own, so a failed run costs time rather than gear, which makes Rook the cheapest way to learn a map or rebuild a stash. Ignore objectives; you\'re not here to contest them.',
  ...
  vandal: {
    ...
    playstyle: 'Set the tempo. Microjet into positions they don\'t expect, commit to close range, rotate out before they adapt. Vandal punishes slow, methodical teams — your job is to make them play your game. Pair with close-range weapons.',
