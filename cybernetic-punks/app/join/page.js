export const metadata = {
  ...
  description: 'Connect your Bungie account and get a full personalized build audit from five AI editors. No streamer, no guide, no tier list can do what this does.',
};
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: '560px', width: '100%' }}>
        ...
        <div style={{
          ...
          marginBottom: '44px',
        }}>MARATHON INTELLIGENCE HUB · TAU CETI IV</div>
        ...
        <p style={{
          ...
          Five AI editors are standing by to analyze your build, assess your meta position, and deliver a personalized coaching audit. No streamer, no guide, no tier list can do what this does.
        </p>
