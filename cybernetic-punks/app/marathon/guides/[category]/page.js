...
const CATEGORIES = {
  shells: {
    ...
    label: 'SHELL GUIDES',
    color: '#9b5de5',
    title: 'Marathon Shell Guides - Ability Breakdowns & Playstyles',
  ...
  ranked: {
    ...
    label: 'RANKED GUIDES',
    color: '#ffd700',
    title: 'Marathon Ranked Guides - Holotag Strategy & Tier Climb',
  ...
  weapons: {
    ...
    label: 'WEAPON GUIDES',
    color: '#ff8800',
    title: 'Marathon Weapon Guides - Per-Weapon Analysis & Stats',
  ...
  extraction: {
    ...
    label: 'EXTRACTION',
    color: '#00d4ff',
    title: 'Marathon Extraction Guides - Exfil Routes & Loot Strategy',
  ...
  beginner: {
    ...
    label: 'BEGINNER',
    color: '#00ff41',
    title: 'Marathon Beginner Guide - New Runner Tips & First Builds',
  ...
  progression: {
    ...
    label: 'PROGRESSION',
    color: '#ffffff',
    title: 'Marathon Progression Guide - Faction Paths & Upgrades',
  ...
  stealth: {
    ...
    label: 'STEALTH',
    color: '#cc44ff',
    title: 'Marathon Stealth Guide - Silent Plays & Cloaking',
  ...
  squad: {
    ...
    label: 'SQUAD PLAY',
    color: '#00d4ff',
    title: 'Marathon Squad Play Guide - Trio Tactics & Comms',
  ...
  solo: {
    ...
    label: 'SOLO PLAY',
    color: '#ff8800',
    title: 'Marathon Solo Guide - Solo Queue Strategy & Builds',
  ...
  endgame: {
    ...
    label: 'ENDGAME',
    color: '#ff2d55',
    title: 'Marathon Endgame Guide - High-Rank Tactics & Prestige',
  ...
  pvp: {
    ...
    label: 'PVP',
    color: '#ff2222',
    title: 'Marathon PvP Guide - Combat Tactics & Win Conditions',
  ...
  'cryo-archive': {
    ...
    label: 'CRYO ARCHIVE',
    color: '#00d4ff',
    title: 'Marathon Cryo Archive Guide - Endgame Raid & Vaults',
