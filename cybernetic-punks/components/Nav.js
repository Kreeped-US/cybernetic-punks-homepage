...
export default function Nav() {
  ...
  if (pathname === '/' || (pathname && (pathname.startsWith('/dmz') || pathname.startsWith('/wardogs') || pathname.startsWith('/profile-preview') || pathname === '/admin' || pathname.startsWith('/admin/')))) return null;
