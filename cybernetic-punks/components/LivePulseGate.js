    ...
    <div style={{
      ...
      {hasSteam && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 900, color: '#fff', fontFamily: 'Orbitron, monospace', letterSpacing: 0.5 }}>{formatNum(stats.steam.value)}</span>
      ...
      {hasTwitch && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 900, color: '#fff', fontFamily: 'Orbitron, monospace', letterSpacing: 0.5 }}>{formatNum(stats.twitch.value)}</span>
          <span style={{ fontSize: 9, color: 'rgba(255,255,255,0.3)', letterSpacing: 1, fontFamily: 'monospace', fontWeight: 700 }}>WATCHING · {stats.twitch.stream_count} LIVE</span>
        </div>
      )}
    </div>
  );
